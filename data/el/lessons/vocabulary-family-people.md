...
- **ο μπαμπάς** *(o ba-bás)* = dad
- **το παιδί** *(to pe-dí)* = child

## 2. People (Άνθρωποι)
- **ο άντρας** *(o án-dras)* = man / husband
- **η γυναίκα** *(ee yee-né-ka)* = woman / wife
- **ο φίλος** *(o fí-los)* = friend (male)
- **η φίλη** *(ee fí-lee)* = friend (female)
