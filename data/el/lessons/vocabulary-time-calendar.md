...
- **η Πέμπτη** *(ee pém-ptee)* = Thursday
- **η Παρασκευή** *(ee pa-ra-ske-ví)* = Friday
- **το Σάββατο** *(to sáv-va-to)* = Saturday
- **η Κυριακή** *(ee kee-rya-kí)* = Sunday

## 2. Time Expressions (Εκφράσεις χρόνου)
- **σήμερα** *(sí-me-ra)* = today
