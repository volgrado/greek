# Voices and Moods
Greek verbs have two **Voices** (who performs/receives the action) and several **Moods** (the attitude of the speaker towards the action).
...
Greek also has **Participles** (Μετοχή) ending in *-οντας* (like "-ing" in English) and an **Infinitive** form (used in perfect tenses).
